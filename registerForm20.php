...
<head>
    ...
    <title class='reForm20'>Maintaining Student Status Request Form</title>
...
<body>
    <form action="pdfReForm20.php" method="post" target="_blank" id="myform1" novalidate>
        ...
        <div class="st">
            <div class="h"><br>
                <h3 class='reForm20'>แบบคำร้องขอรักษาสภาพการเป็นนักศึกษา</h3>
            </div>
           ...
           <div>
            ...
            <div class="row g-1 mt-5">
                <div class="col-auto">
                    <label class="schoolYear">มีความประสงค์ขอรักษาสภาพการเป็นนักศึกษา ในภาคการศึกษาที่</label>
                </div>
                <div class="col-auto">
                    <input type="number" name="schoolYear" class="form-control" style="text-align: center; width:124px;" required>
                    <div class="invalid-feedback invalid">
                        กรุณากรอกข้อมูล
                    </div>
                </div>
                ...
                <div class="col-auto">
                    <input type="number" name="academicYear" class="form-control" style="text-align: center; width:124px;" required>
                    <div class="invalid-feedback invalid">
                        กรุณากรอกข้อมูล
                    </div>
                </div>
            ...
            <div>
                <div class="form-group mb-3 starlabel">
                    ...
                    <div class="col">
                        <textarea class="form-control" name="due" rows="3" style="resize: none;" style="resize: none;" required></textarea>
                        <div class="invalid-feedback invalid">
                            กรุณากรอกข้อมูล
                        </div>
                    </div>
            ...
            <div class="starlabel">
                <label class="pay">วิธีการชำระเงิน</label>
            </div>
            <div class="col-auto">
                &nbsp;&nbsp;&nbsp;
                <input type="radio" class="form-check-input" name="pay" value="1" required />
                <label class='ra1'>ให้มหาวิทยาลัยจัดส่งใบแจ้งยอดชำระเงินทาง E-mail หลังจากได้รับการแจ้งจากมหาวิทยาลัย</label>
            </div>
            <div class="row col-lg-6 mb-3" id="mail" style="display: none; padding-left:50px;">
                <div class="starlabel">
                    <label>Email</label>
            ...
            <div class="col-auto">
                &nbsp;&nbsp;&nbsp;
                <input type="radio" class="form-check-input" name="pay" value="2" required />
